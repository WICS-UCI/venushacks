	...
	return (
		<section className="relative flex w-full aspect-[1280/1000]">
			...
			<Image
				...
				alt="Pond"
				className={
					"absolute left-1/2 top-1/2  w-[80%] -translate-x-1/2 -translate-y-1/2"
				}
			/>
			<motion.div
				className={
					"absolute left-[50%] top-[34%] w-[17%] -translate-x-1/2 -translate-y-1/2"
				}
				animate={{ y: [0, -12, 0] }}
				transition={{
					duration: 3,
			...
			>
				...
				<Image
					...
					alt="Apple"
					className={
						"absolute left-[50%] top-[13%] w-[22%] -translate-x-1/2 -translate-y-1/2"
					}
				/>
			</motion.div>
			<Image
				...
				alt="Yellow Capybara"
				className={
					"absolute left-[67%] top-[63%] w-[17%] -translate-x-1/2 -translate-y-1/2"
				}
			/>
			<Image
				src={green}
				alt="Green Capybara"
				className={
					"absolute left-[86%] top-[54%] w-[18%] -translate-x-1/2 -translate-y-1/2"
				}
			/>
			<Image
				src={basket}
				alt="basket"
				className={
					"absolute left-[80%] top-[68%] w-[13%] -translate-x-1/2 -translate-y-1/2"
				}
			/>
			<Image
				src={ant}
			...
			<Image
				...
				alt="Orange Capybara"
				className={
					"absolute left-[38%] top-[50%] w-[18%] -translate-x-1/2 -translate-y-1/2"
				}
			/>
			<Image
				src={splash}
				alt="Splash"
				className={
					"absolute left-[40%] top-[52%] w-[26%] -translate-x-1/2 -translate-y-1/2"
				}
			/>
			<Image
				src={ant2}
				alt="Ant2"
				className={
					"absolute left-[11%] top-[47%] w-[12%] -translate-x-1/2 -translate-y-1/2"
				}
			/>
			<Image
				src={blue}
				alt="Blue Capybara"
				className={
					"absolute left-[20%] top-[60%] w-[19%] -translate-x-1/2 -translate-y-1/2"
				}
			/>
			<Image
				src={red}
				alt="Red Capybara"
				className={
					"absolute left-[32%] top-[72%] w-[24%] -translate-x-1/2 -translate-y-1/2"
				}
			/>
			<Image
				src={cherry}
