		...
		<>
			...
			<div className="fixed inset-0 z-50 flex items-center justify-center">
				<div className="relative z-10 max-w-sm p-8 bg-white shadow-2xl md:p-12 md:max-w-lg rounded-3xl">
					<h2 className="mb-2 text-2xl text-center text-black font-sniglet tracking-wide">
						I&apos;m applying to be a...
					</h2>
					<p className="mb-5 text-sm italic text-center text-gray-500 font-figtree">
						...
						{roles.map((role) => (
							...
							>
								...
								<div className="flex flex-col gap-1">
									<p
										className="mb-0 text-lg font-sniglet tracking-wide"
										style={{ color: "#1a1a2e" }}
									>
										{role.title}
									</p>
									<p className="mb-0 text-xs leading-snug text-gray-500 font-figtree">
										{role.description}
									</p>
								</div>
							</button>
